<template>
  <footer class="footer">
    <div class="container footer__container footer__flex">
      <svg
      ...
      <div class="footer__links">
        <section class="links">
          <h4 class="links__heading">Features</h4>
          <ul class="links__list">
            <li class="links__link"><a href="#">Link Shortening</a></li>
            <li class="links__link"><a href="#">Branded Links</a></li>
            <li class="links__link"><a href="#">Analytics</a></li>
          </ul>
        </section>
        <section class="links">
          <h4 class="links__heading">Resources</h4>
          <ul class="links__list">
            <li class="links__link"><a href="#">Blog</a></li>
            <li class="links__link"><a href="#">Developers</a></li>
            <li class="links__link"><a href="#">Support</a></li>
          </ul>
        </section>
        <section class="links">
          <h4 class="links__heading">Company</h4>
          <ul class="links__list">
            <li class="links__link"><a href="#">About</a></li>
            <li class="links__link"><a href="#">Our Team</a></li>
            <li class="links__link"><a href="#">Careers</a></li>
            <li class="links__link"><a href="#">Contact</a></li>
          </ul>
        </section>
        <div class="social-media">
          ...
          <a href="#" class="social-media__icon">
            <svg
              ...
              width="24"
              height="24"
              class="social-media__icon--pinterest"
            >
              <path
                fill="#FFF"
          ...
          <a href="#" class="social-media__icon">
            <svg
              ...
              width="24"
              height="24"
              class="social-media__icon--instagram"
            >
              <path
                fill="#FFF"
...
.footer {
  padding: 3rem 0;
  background-color: var(--neutral-dark-violet-color);
