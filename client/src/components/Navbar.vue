    ...
    <div class="container nav__container">
      <div class="row nav__row">
        <div class="desktop-nav">
          ...
          <a class="link link--1" href="#">Features</a>
          <a class="link link--2" href="#">Pricing</a>
          <a class="link link--3" href="#">Resources</a>
          <a class="link link--4" href="#">Login</a>
          <button class="button button--md">login</button>
        </div>

        <div class="menu">
          <button class="menu__mobile-btn" v-on:click="showModal">
            <svg
              class="menu__mobile-icon"
      ...
      <div class="menu-modal" v-if="isModalShowing">
        <a href="#" class="menu-modal__link">Features</a>
        <a href="#" class="menu-modal__link">Pricing</a>
...
.menu-modal {
  ...
  &__line {
    ...
    width: 100%;
    opacity: 0.2;
    background-color: var(--neutral-gray-violet-color);
    margin: 0 0 2rem 0;
  }
